...
<section
    ...
    @class([
        ...
        'hide-scrollbar relative -mr-4 flex snap-x overflow-x-scroll *:snap-start *:not-[.gradient]:min-w-32 sm:mr-0 sm:grid sm:overflow-visible sm:*:size-full' => $scrollableOnMobile,
